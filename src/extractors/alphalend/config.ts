...
export const SUI_RPC_URL =
  process.env.SUI_RPC || 'https://sui-rpc.publicnode.com'

// AlphaLend Markets Container object ID
// Source: DefiLlama adapter
export const ALPHALEND_MARKETS_CONTAINER =
  '0x2326d387ba8bb7d24aa4cfa31f9a1e58bf9234b097574afb06c5dfb267df4c2e'

// Market type pattern for dynamic field queries
export const ALPHALEND_MARKET_TYPE =
  '0x8f8ded194f7a4d68950e44c9ff83a041b4a1c7cbbe06b188523915b6eba62c7a::market::Market'

// tBTC coin type on Sui
export const SUI_TBTC_COIN_TYPE =
